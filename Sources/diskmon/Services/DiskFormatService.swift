...
final class DiskFormatService {
    ...
    func request(for disk: DiskInfo, personality: FormatPersonality, confirm: String, volumeName: String, partitionBSD: String = "") -> FormatRequest {
        FormatRequest(
    ...
    func format(disk: DiskInfo, personality: FormatPersonality, confirm: String, volumeName: String, remountAfter: Bool = true) async -> String {
        var part = ""
        ...
        let req = request(for: disk, personality: personality, confirm: confirm, volumeName: volumeName, partitionBSD: part)
        ...
        let joined = [erase, mounted].filter { !$0.isEmpty }.joined(separator: "\n")
        lastMessage = joined
        return joined
    }
