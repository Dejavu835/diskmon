...
public enum SmartParse {
    ...
    /// ATA spare attributes (e.g. Available_Reservd_Space): normalized VALUE
    /// is remaining spare percent (100 = full). RAW is vendor-specific and
    /// must not be clamped into a fake 0–100 spare.
    public static func sparePercentFromNormalizedValue(_ valueToken: String) -> Int? {
